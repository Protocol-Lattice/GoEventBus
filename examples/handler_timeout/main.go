...
func main() {
	...
	dispatcher.Register("demo", func(ctx context.Context, ev GoEventBus.Event) (GoEventBus.Result, error) {
		select {
	...
	_ = store.Subscribe(hctx, GoEventBus.Event{ID: "H-1", Projection: "demo"})
